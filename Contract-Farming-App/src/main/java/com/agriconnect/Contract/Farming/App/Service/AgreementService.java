...
public class AgreementService {
    ...
    public Agreement uploadAgreement(MultipartFile file, String transactionHash, String pdfHash, String orderId) throws Exception {
        ...
        try {
            ...
            Agreement agreement
                    = new Agreement(orderId,file.getSize(), fileName,
                    file.getContentType(),
    ...
    public Agreement getAgreementByPdfHash(String pdfHash){
        return agreementRepository.findByTransactionHash(pdfHash).orElseThrow(()->new EntityNotFoundException("Could not find agreement with pdf hash " + pdfHash));
    }
